...
export default function EditPricingModal({ rule, onClose, onSave }: EditPricingModalProps) {
  ...
  const [formData, setFormData] = useState({
    fromBusinessId: rule.fromBusinessId,
    toBusinessId: rule.toBusinessId,
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200 sticky top-0 bg-white">
          <h3 className="text-lg font-semibold text-gray-900">Edit Pricing Rule</h3>
          <button
            onClick={onClose}
